...
from models.backbone.mobileone import MobileOneBlock
from models.backbone.replknet import ReparamLargeKernelConv
...
@register_model
def fastvit_t8(inference_mode=False, **kwargs):
...
if __name__=='__main__':
    net = fastvit_t8()
    print('unexpected layername:', net.load_state_dict(torch.load('../fastvit_t8.pth.tar', map_location='cpu')["state_dict"], strict=False))
    net.cuda()
