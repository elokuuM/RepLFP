...
from models.backbone.efficientvit.apps.data_provider.random_resolution import RRSController
from models.backbone.efficientvit.models.utils import val2tuple
...
class DataProvider:
    ...
    def build_valid_transform(self, image_size: [] or None = None) -> any:
        raise NotImplementedError

    def build_train_transform(self, image_size: [] or None = None) -> any:
        raise NotImplementedError
    ...
    def assign_active_image_size(self, new_size: int or []) -> None:
